...
if(telescope_CONFIG_INCLUDED)
  return()
endif()
set(telescope_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(telescope_SOURCE_PREFIX /home/rosmgr/quimal/src/telescope)
  set(telescope_DEVEL_PREFIX /home/rosmgr/quimal/devel)
  set(telescope_INSTALL_PREFIX "")
  set(telescope_PREFIX ${telescope_DEVEL_PREFIX})
else()
  set(telescope_SOURCE_PREFIX "")
  set(telescope_DEVEL_PREFIX "")
  set(telescope_INSTALL_PREFIX /home/rosmgr/quimal/install)
  set(telescope_PREFIX ${telescope_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'telescope' is deprecated")
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      get_filename_component(include "${telescope_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'telescope' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rosmgr <rosmgr@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'telescope' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosmgr/quimal/install/${idir}'.  Ask the maintainer 'rosmgr <rosmgr@todo.todo>' to fix it.")
    endif()
    _list_append_unique(telescope_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^debug|optimized|general$")
    list(APPEND telescope_LIBRARIES ${library})
...
>>>>>>> b316416f9c5a00b678fe48214420205e24e6a35d
    ...
    endforeach()
    if(lib)
      _list_append_unique(telescope_LIBRARY_DIRS ${lib_path})
      list(APPEND telescope_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'telescope'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND telescope_LIBRARIES ${lib})
    endif()
  endif()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 telescope_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${telescope_dep}_FOUND)
      find_package(${telescope_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${telescope_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(telescope_INCLUDE_DIRS ${${telescope_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(telescope_LIBRARIES ${telescope_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${telescope_dep}_LIBRARIES})
  _list_append_deduplicate(telescope_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(telescope_LIBRARIES ${telescope_LIBRARIES})

  _list_append_unique(telescope_LIBRARY_DIRS ${${telescope_dep}_LIBRARY_DIRS})
